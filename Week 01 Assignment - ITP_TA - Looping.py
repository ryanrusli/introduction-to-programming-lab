...
for i in range(1,x+1):                #i is a loop for the number of rows, and continues looping while the number of rows is less than 6
...
x = int(input("Input number of rows"))
for i in range(x,0,-1):             #i is a loop for the number of rows, and loops downwards from 5 to 1
...
for i in range(1,x):                #i is a loop for the number of rows, and continues looping while the number of rows is less than 6 
    print((s)*(" "), "*"*(x-i))     #prints " " by the number of spaces 's', followed by printing a n"*" multiplied by (6 subtracted by the current row number)
...
x = int(input("Input number of rows"))
for i in range(1,x):                #i is a loop for the number of rows, and continues looping while the number of rows is less than 6 
    print(" "*(x-i), "*"*(i*2-1))   #prints a " " multiplied by (6 subtracted by the current row number), followed by an "*" multiplied by 2 and the current row number, 
...
for i in range(1,6):                #i is a loop for the number of rows of the pyramid, and continues looping while the number of rows is less than 6 
    print(" "*(6-i), "*"*(i*2-1))   #prints a " " multiplied by (5 subtracted by the current row number), followed by an "*" multiplied by 2 and the current row number, 
